(function () {
  ...
  class MyReporter {
    ...
    onRunComplete(test, results) {
      ...
      const outputPath = path.resolve(__dirname, '..', 'reports', 'coverage', 'results.json');
      fs.writeFileSync(outputPath, JSON.stringify({suites: mySuite.toJSON(), stats: this.stats}, null, 2), 'utf8');
